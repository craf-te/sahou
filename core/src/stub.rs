...
fn markers(comment: &str, node: &str, hashes: &BTreeMap<String, String>) -> String {
    let mut s = format!("{comment} sahou:stub node={node}\n");
    for (c, h) in hashes {
