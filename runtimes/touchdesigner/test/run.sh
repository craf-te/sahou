...
# and a generated descriptor (`sahou gen runtimes/touchdesigner/examples/schema.sahou.yaml --out-dir runtimes/touchdesigner/examples/gen`).
...
echo "== payload_test =="
$CXX $CXXFLAGS runtimes/touchdesigner/src/payload.cpp runtimes/touchdesigner/test/payload_test.cpp -o "$OUT/payload_test"
"$OUT/payload_test"

echo
echo "== envelope_test =="
$CXX $CXXFLAGS runtimes/touchdesigner/src/envelope.cpp runtimes/touchdesigner/test/envelope_test.cpp -o "$OUT/envelope_test"
"$OUT/envelope_test"
